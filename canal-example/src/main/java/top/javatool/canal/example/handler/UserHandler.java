...
public class UserHandler implements EntryHandler<User> {
    ...
    public void insert(User user) {
        ...
        logger.info("insert message  {}", userJsonString);
    ...
    public void update(User before, User after) {
        ...
        logger.info("update before {} ", userBeforeJsonString);
        logger.info("update after {}", userAfterJsonString);
        String table = CanalContext.getModel().getTable();
//        Map<String, Object> userBeforeMap = JSON.parseObject(userBeforeJsonString, Map.class);
    ...
    public void delete(User user) {
        logger.info("delete  {}", JSON.toJSONString(user));
        String table = CanalContext.getModel().getTable();
